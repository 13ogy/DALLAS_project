...
- outputs/tables/data_dictionary.json - description of columns
...
def build_features(input_csv: str, output_base: str = "data/processed/features", verify_leakage: bool = False) -> dict:
    ...
    # Optional leakage verification, we used it in tests
    if verify_leakage:
    ...
    required_cols = ["lag_1h", "lag_24h", "rollmean_24h", "y_next",
                     "temp_z"]  # We prioritize temp_z over norm
    ...
    # We prefer generally Parquet, fallback to CSV only
    wrote_parquet = False
    try:
    ...
    # Data dictionary to keep the naming short and transparency
    data_dict = {
